          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-8">
                ...
                <div className="mt-3">
                  <p>
                    Whether you like a basic brew or larger-than-life latte,
                    here are five of the best US cities for coffee-lovers to
                    visit for the ultimate caffeine fix.
                  </p>
                </div>
                <section>
                  <div>
                  ...
                  <div className="my-3">
                    <p>
                      ...
                      Coffee for their famous fruity flavors (and amazing
                      mochas), or Stumptown Coffee Roasters for unique seasonal
                      coffees like the piña colada cold brew.
                    </p>
                  </div>
                </section>
                <section>
                  ...
                  <div className="my-3">
                    <p>
                      As the birthplace of Starbucks, the rainy city of Seattle
                      is a major US hub for all things coffee. Visit the first
                      ever Starbucks at 1st and Pike before heading just nine
                      blocks away to the 15,000-square-foot Starbucks Roastery –
                      a self-proclaimed Willy Wonka’s Chocolate Factory for
                      coffee-lovers. For a more local experience, visit
                      coffeehouses like Café Allegro which claims to be
                      “Seattle’s oldest espresso bar.” Switch over to decaf
                      before heading to sleep at the Mayflower Park Hotel built
                      in 1927 and located downtown.
                    </p>
                  </div>
                </section>
                <section>
                ...
                <section>
                  ...
                  <div className="my-3">
                    <p>
                      ...
                      forefront of the national speciality coffee scene thanks
                      to progressive roasting styles and locally grown,
                      high-quality select beans. Coffee spots like Spyhouse,
                      Dogwood, Duluth Coffee Company and UP focus on quality and
                      ethics in their roasting – and make a pretty mean cup of
                      joe. Stay downtown at the Millennium Minneapolis, which is
                      connected to the skyway so you won't even have to step
                      outside before your morning brew.
                    </p>
                  </div>
                </section>
              </div>
