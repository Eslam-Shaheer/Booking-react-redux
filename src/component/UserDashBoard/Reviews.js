...
export default function Reviews() {
    ...
    useEffect(()=>{
        ...
        axiosInstance.get("filter/review").then((result) => {
        ...
        return (
                ...
                revs?<div className="mt-3" >
            <div>
                <h4>Hotels Reviews ({userReviews&&userReviews.hotels.length})</h4>
                {
                    userReviews&&userReviews.hotels.map((prop,index)=>{
                 ...
                 <div>
                          <div className="row card-body bg-seconary m-3">
                            ...
                            <img className=" col-lg-6 col-md-8 col-sm-12 rev-img" src={prop.hotelImg}/>
                            ...
                            <div className="star ">{star}</div>
                              ...
                              <div className="rev-body col-md-8 mt-4">
                                  ...
                                  <span className="text-muted "> {createdAt.toDateString()}</span>
                              </div>
                          </div>
                              <hr/>
                              </div>
                ...
                <h4>Apartments Reviews({userReviews&&userReviews.apartments.length})</h4>

            <div>
                {
                    userReviews&&userReviews.apartments.map((prop,index)=>{
                 ...
                 <div>
                          <div className="row card-body bg-seconary m-3">
                            ...
                            <img className=" col-lg-6 col-md-8 col-sm-12 rev-img" src={prop.apartmentImg}/>
            ...
            <h4>Campgrounds Reviews({userReviews&&userReviews.campgrounds.length})</h4>

<div>
    {
        userReviews&&userReviews.campgrounds.map((prop,index)=>{
     ...
     <div>
              <div className="row card-body bg-seconary m-3">
                ...
                <img className=" col-lg-6 col-md-8 col-sm-12 rev-img" src={prop.campgroundImg}/>
