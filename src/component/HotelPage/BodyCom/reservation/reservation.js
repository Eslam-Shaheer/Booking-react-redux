        ...
        case "City view":
          viewElement.push(
            <div className="d-flex align-items-center">
              ...
              <span className="ms-1">City view</span>
            </div>
          );
        ...
        case "Pool view":
          viewElement.push(
            <div className="d-flex align-items-center">
              ...
              <span className="ms-1">Pool view</span>
            </div>
          );
          setHotelWith(viewElement);
          break;
        case "Landmark view":
          viewElement.push(
            <div className="d-flex align-items-center">
              ...
              <span className="ms-1">Landmark view</span>
            </div>
          );
          setHotelWith(viewElement);
          break;
        case "Quiet street view":
          viewElement.push(
            <div className="d-flex align-items-center">
              ...
              <span className="ms-1">Quiet street view</span>
            </div>
          );
          setHotelWith(viewElement);
          break;
        case "Sea view":
          viewElement.push(
            <div className="d-flex align-items-center">
              ...
              <span className="ms-1">Sea view</span>
            </div>
          );
          setHotelWith(viewElement);
          break;
        ...
        <div className="Reservation mt-3">
          <div className="p-3">
            ...
            <div className="d-flex flex-column">
              <h6 className="text-secondary">Hotel with:</h6>
              <div className="ms-0">
                {hotelWith.map((item) => {
                  return item;
                })}
