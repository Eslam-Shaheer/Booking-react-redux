            ...
            <div className="card d-flex align-content-center">
              <div className="card-body    d-flex align-items-center">
                ...
                <span>
                  ...
                  restrictions before you travel. <a href="">Learn more</a>{" "}
                </span>
              </div>
            </div>
          </div>
                    ...
                    <div className="card card-div mb-3 px-2 ">
                        <div className="row g-0 justify-content-evenly align-items-center">
                            <div className="col-md-3 col-lg-2 col-1 ">
                                <img src="https://cf.bstatic.com/xdata/images/city/square100/613095.webp?k=8caf960d96a59e284ac1518ac8777e89d17fda6572acd84dbec151f627c7bf07&o="
                                    className="img-fluid rounded" alt="..."/>
                            </div>
                            <div className="col-9">
                                <div className="card-body  ">
                                    <p className="card-title recent-title">Card title</p>
